...
- Monarchy intentionally does not move the cursor, focus Roblox, click Play, or
  send Play-related keyboard input. Use an external autoclicker or click Play
  manually. Monarchy only waits for OCR confirmation that the Roll screen was
  reached before beginning biome verification.
...
- Display scaling and Roblox UI changes can affect Roll OCR. Keep Windows
  scaling at 100% while troubleshooting Roll detection.
